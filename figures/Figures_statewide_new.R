...
par(xpd=NA)
text(x = -15, y = 31900, labels = substitute(paste(bold('Western Islands'))), cex = 2.5)
text(x = -15, y = 20100, labels = substitute(paste(bold('Southwest and Central Alaska'))), cex = 2.5)
text(x = -15, y = 8400, labels = substitute(paste(bold('Southeast Alaska'))), cex = 2.5)
text(x = -23, y = -3200, labels = substitute(paste(bold('Glacial Fjord SSUs in Central and Southeast Alaska'))), cex = 2.5)
